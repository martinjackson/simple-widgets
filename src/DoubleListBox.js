...
*/
    ...
    let topButton = <svg viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg">
                        <g fill="none">
                            <path stroke="black" stroke-width="3" d="M25 10 L25 45" />
                            <path stroke="black" stroke-width="3" d="M25 10 L15 25" />
                            <path stroke="black" stroke-width="3" d="M25 10 L35 25" />
                            <path stroke="black" stroke-width="3" d="M10  5 L40 5" />
                        </g>
                    </svg>;
    ...
    let upButton =  <svg viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg">
                        <g fill="none">
                            <path stroke="black" stroke-width="3" d="M25 5 L25 45" />
                            <path stroke="black" stroke-width="3" d="M25 5 L15 25" />
                            <path stroke="black" stroke-width="3" d="M25 5 L35 25" />
                        </g>
                    </svg>;
    ...
    let downButton =    <svg viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg">
                            <g fill="none">
                                <path stroke="black" stroke-width="3" d="M25  5 L25 40" />
                                <path stroke="black" stroke-width="3" d="M25 45 L15 25" />
                                <path stroke="black" stroke-width="3" d="M25 45 L35 25" />
                            </g>
                        </svg>;
    ...
    let bottomButton =  <svg viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg">
                            <g fill="none">
                                <path stroke="black" stroke-width="3" d="M25  5 L25 40" />
                                <path stroke="black" stroke-width="3" d="M25 40 L15 25" />
                                <path stroke="black" stroke-width="3" d="M25 40 L35 25" />
                                <path stroke="black" stroke-width="3" d="M10 45 L40 45" />
                            </g>
                        </svg>;
