...
var copyStyle = function copyStyle(_copyStyle) {
  ...
  style.backgroundColor = _Theme_js__WEBPACK_IMPORTED_MODULE_0__.defaultThemeSettings.normalColor;
  return style;
};
/***********************************************************************************************
 *
...
var processStyleScreen = function processStyleScreen(invalidValues, constant, style) {
  style.backgroundColor = invalidValues[constant].validity === true ? _Theme_js__WEBPACK_IMPORTED_MODULE_0__.defaultThemeSettings.errorColor : _Theme_js__WEBPACK_IMPORTED_MODULE_0__.defaultThemeSettings.normalColor;
  return style;
};
/***********************************************************************************************
 *
