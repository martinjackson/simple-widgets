...
var ContextMenu = function ContextMenu(propsIn) {
  ...
  var positionX = propsIn.positionX,
      ...
      props = _objectWithoutProperties(propsIn, ["positionX", "positionY", "noLeave", "noCancel", "menu", "backColor", "border", "radius"]);
...
var _Choice = function _Choice(propsIn, ref) {
  var list = propsIn.list,
      ...
      size = propsIn.size,
      value = propsIn.value,
      props = _objectWithoutProperties(propsIn, ["list", "choices", "size", "value"]); // Value should not be a prop, take it out and ignore it.
