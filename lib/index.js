...
var AlertModal = function AlertModal(props) {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, props.show === true ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Modal__WEBPACK_IMPORTED_MODULE_1__.default, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, props.message), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
    name: "ok",
    onClick: function onClick() {
      return props.showFunct(false);
    },
    style: _Theme__WEBPACK_IMPORTED_MODULE_2__.buttonStyle
  }, "OK"))) : null);
};
...
var DatePicker = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(DatePicker, [{
    key: "render",
    value: function render() {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_UnstyledDatePicker__WEBPACK_IMPORTED_MODULE_2__.default, _extends({}, this.props, {
        defaultStyles: true
      }));
    }
  }]);
...
/*!********************************!*\
  ...
  \********************************/
/*! namespace exports */
/*! export DatePickerStyle [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
  ...
  _createClass(DoubleListBox, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
        ...
        style: topSt
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("label", null, this.props.leftTitle), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("label", {
        style: listSt
      }, this.props.rightTitle)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
        style: topSt
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_List__WEBPACK_IMPORTED_MODULE_2__.List, {
      ...
      }, "<<"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("br", null)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_List__WEBPACK_IMPORTED_MODULE_2__.List, {
...
var ErrorModal = function ErrorModal(props) {
  ...
  if (props.hasOwnProperty('buttonStyle') === true) {
    _Theme__WEBPACK_IMPORTED_MODULE_2__.buttonStyle = props.buttonStyle;
  }
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, props.show === true ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Modal__WEBPACK_IMPORTED_MODULE_1__.default, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", {
    style: marginStyle
  }, "Error"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", null, props.message), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
    name: "ok",
    onClick: function onClick() {
...
/*!************************!*\
  ...
  \************************/
/*! namespace exports */
/*! export clearInvalidDual [provided] [no usage info] [missing usage info prevents renaming] */
/*! export clearInvalidScreen [provided] [no usage info] [missing usage info prevents renaming] */
/*! export clearInvalidScreenOnly [provided] [no usage info] [missing usage info prevents renaming] */
/*! export clearInvalidTable [provided] [no usage info] [missing usage info prevents renaming] */
/*! export copyStyle [provided] [no usage info] [missing usage info prevents renaming] */
/*! export getInvalidMessage [provided] [no usage info] [missing usage info prevents renaming] */
/*! export invalidStyling [provided] [no usage info] [missing usage info prevents renaming] */
/*! export isConstant [provided] [no usage info] [missing usage info prevents renaming] */
/*! export isInvalid [provided] [no usage info] [missing usage info prevents renaming] */
/*! export processStyleScreen [provided] [no usage info] [missing usage info prevents renaming] */
/*! export processStyleTable [provided] [no usage info] [missing usage info prevents renaming] */
/*! export resetDisplayScreen [provided] [no usage info] [missing usage info prevents renaming] */
/*! export resetDisplayTable [provided] [no usage info] [missing usage info prevents renaming] */
/*! export setInvalidDual [provided] [no usage info] [missing usage info prevents renaming] */
/*! export setInvalidScreen [provided] [no usage info] [missing usage info prevents renaming] */
/*! export setInvalidTable [provided] [no usage info] [missing usage info prevents renaming] */
/*! export validCheckDual [provided] [no usage info] [missing usage info prevents renaming] */
/*! export validCheckScreen [provided] [no usage info] [missing usage info prevents renaming] */
/*! export validCheckTable [provided] [no usage info] [missing usage info prevents renaming] */
/*! export validStyling [provided] [no usage info] [missing usage info prevents renaming] */
/*! export wasClickedScreen [provided] [no usage info] [missing usage info prevents renaming] */
/*! export wasClickedTable [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
...
var clearInvalidDual = function clearInvalidDual(invalidValues, screen, table) {
  ...
  for (var _i = table[0]; _i <= table[1]; _i++) {
    invalidValues[_i].validity = [];
    invalidValues[_i].display = [];
    invalidValues[_i].index = [];
    invalidValues[_i].message = [];
  }
...
var copyStyle = function copyStyle(_copyStyle) {
  ...
  style.backgroundColor = _Theme__WEBPACK_IMPORTED_MODULE_0__.defaultThemeSettings.backgroundColor;
  return style;
};
/***********************************************************************************************
 *
...
var processStyleScreen = function processStyleScreen(invalidValues, constant, style) {
  style.backgroundColor = invalidValues[constant].validity === true ? _Theme__WEBPACK_IMPORTED_MODULE_0__.defaultThemeSettings.errorColor : _Theme__WEBPACK_IMPORTED_MODULE_0__.defaultThemeSettings.backgroundColor;
  return style;
};
/***********************************************************************************************
 *
  ...
  for (var j = 0; j < invalidValues[constant].validity.length; j++) {
    if (pos === invalidValues[constant].index[j]) {
      ...
      if (invalidValues[constant].validity[j] === true) {
        ...
        style.backgroundColor = _Theme__WEBPACK_IMPORTED_MODULE_0__.defaultThemeSettings.errorColor;
      }
    }
  }
...
var validStyling = function validStyling() {
  return {
    backgroundColor: _Theme__WEBPACK_IMPORTED_MODULE_0__.defaultThemeSettings.backgroundColor
  };
};
/**********************************************************************************************
 *
...
var invalidStyling = function invalidStyling() {
  return {
    backgroundColor: _Theme__WEBPACK_IMPORTED_MODULE_0__.defaultThemeSettings.errorColor
  };
};
/*********************************************************************************************
 *
...
var Choice = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().forwardRef(function (propsIn, ref) {
  ...
  if (props.multiple) {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("select", props, opt.map(function (el, k) {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("option", {
        key: pref + k,
        value: el
      }, el);
...
var List = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().forwardRef(function (props, ref) {
...
/* harmony import */ var _List__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./List */ "./src/List.js");
/* harmony import */ var _Invalid__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Invalid */ "./src/Invalid.js");
/* harmony import */ var _AlertModal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./AlertModal */ "./src/AlertModal.js");
...
var SearchSortTable = function SearchSortTable(props) {
  var Theme = _toConsumableArray(_Theme__WEBPACK_IMPORTED_MODULE_5__.defaultThemeSettings);

  var error = false; // Indicates that an error has occrred

  var MAX_ITEMS = 10; // Validate and set props
  ...
  if (props.hasOwnProperty('letters') === true) {
    if (props.hasOwnProperty('noupper') === true && props.hasOwnProperty('nolower') === true && props.hasOwnProperty('nodigit') === true) {
      console.error('Search Sort Table component: If using letters prop, can not have all three: noupper, nolower, and nodigit');
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null);
    }
  } else if (props.hasOwnProperty('noupper') === true || props.hasOwnProperty('nolower') === true || props.hasOwnProperty('nodigit') === true) {
  ...
  var _useState3 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(props.hasOwnProperty('showAll') === true ? props.data.length : MAX_ITEMS),
  ...
  var _useState9 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
      ...
      setSearchHeaderValues = _useState10[1]; // The value of each header in the table
  ...
  var _useState23 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(props.hasOwnProperty('showAll') === true ? props.data.length : MAX_ITEMS),
      _useState24 = _slicedToArray(_useState23, 2),
      maxItems = _useState24[0],
      setMaxItems = _useState24[1]; // Maximum number of rows to display in the table


  var _useState25 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(props.hasOwnProperty('showAll') === true ? props.data.length : MAX_ITEMS),
  ...
  var _useState33 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0),
      ...
      length = _useState34[0],
      setLength = _useState34[1]; // The length of the data


  var _useState35 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(true),
      _useState36 = _slicedToArray(_useState35, 2),
      filterDisabled = _useState36[0],
      setFilterDisabled = _useState36[1]; // Indicates whether the filtering is enabled or disabled (Filter button)


  var _useState37 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(invalidArray),
      _useState38 = _slicedToArray(_useState37, 2),
      invalid = _useState38[0],
      setInvalid = _useState38[1];

  var _useState39 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(''),
      _useState40 = _slicedToArray(_useState39, 2),
      alertMessage = _useState40[0],
      setAlertMessage = _useState40[1];

  var _useState41 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false),
      _useState42 = _slicedToArray(_useState41, 2),
      showAlert = _useState42[0],
      setShowAlert = _useState42[1];
  /****************************************************************************
   *
  ...
  function populateSearch() {
    ...
    for (var count = MAX_ITEMS; count <= 100; count += 5) {
      values.push(count);
    }
  ...
  if (props.hasOwnProperty('buttonStyle') === true) {
    _Theme__WEBPACK_IMPORTED_MODULE_5__.buttonStyle = props.buttonStyle;
  }
  ...
  var genButtonStyle = (0,_Theme__WEBPACK_IMPORTED_MODULE_5__.generateButton)(_Theme__WEBPACK_IMPORTED_MODULE_5__.buttonStyle, error, false, 'gray');
  var genTopButtonStyle = (0,_Theme__WEBPACK_IMPORTED_MODULE_5__.generateButton)(noButtonStyle, error, topDisabled, 'gray');
  var genPreviousButtonStyle = (0,_Theme__WEBPACK_IMPORTED_MODULE_5__.generateButton)(noButtonStyle, error, previousDisabled, 'gray');
  var genNextButtonStyle = (0,_Theme__WEBPACK_IMPORTED_MODULE_5__.generateButton)(noButtonStyle, error, nextDisabled, 'gray');
  var genBottomButtonStyle = (0,_Theme__WEBPACK_IMPORTED_MODULE_5__.generateButton)(noButtonStyle, error, bottomDisabled, 'gray');
  var genFilterButtonStyle = (0,_Theme__WEBPACK_IMPORTED_MODULE_5__.generateButton)(_Theme__WEBPACK_IMPORTED_MODULE_5__.buttonStyle, error, filterDisabled, 'gray');
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", topButton());
  ...
  if (props.hasOwnProperty('noprevious') === false && props.hasOwnProperty('showAll') === false) {
    previousButtonHTML = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                return _context2.abrupt("return", previousButton());
      ...
      disabled: error || previousDisabled
    }, previousSymbol);
  }
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                return _context3.abrupt("return", nextButton());
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                return _context4.abrupt("return", bottomButton());
        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                return _context5.abrupt("return", allButton());
  ...
  var filterSection = props.hasOwnProperty('nofilter') === true ? null : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_CheckBox__WEBPACK_IMPORTED_MODULE_1__.default, {
    selectedValue: "Y",
    name: "filterOn",
      ...
      return regeneratorRuntime.wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              return _context6.abrupt("return", filterButton());
    ...
    disabled: error || filterDisabled
  }, "Filter"));
  searchStyle = (0,_Invalid__WEBPACK_IMPORTED_MODULE_3__.processStyleScreen)(invalid, SRCHHDR, searchStyle);
  var itemStyle = (0,_Invalid__WEBPACK_IMPORTED_MODULE_3__.validStyling)();
  itemStyle = (0,_Invalid__WEBPACK_IMPORTED_MODULE_3__.processStyleScreen)(invalid, SRCHITEM, itemStyle);
  var searchSection = props.hasOwnProperty('nosearch') === true ? null : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "checkForError"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_List__WEBPACK_IMPORTED_MODULE_2__.Choice, {
    ...
    onClick: function onClick() {
      return (0,_Invalid__WEBPACK_IMPORTED_MODULE_3__.wasClickedScreen)(invalid, SRCHHDR, setInvalid);
    },
    style: searchStyle,
    disabled: error
  }), (0,_Invalid__WEBPACK_IMPORTED_MODULE_3__.isInvalid)(invalid[SRCHHDR], -1) === true ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    ...
    onClick: function onClick() {
      return (0,_Invalid__WEBPACK_IMPORTED_MODULE_3__.wasClickedScreen)(invalid, SRCHITEM, setInvalid);
    },
    style: itemStyle,
    disabled: error
  }), (0,_Invalid__WEBPACK_IMPORTED_MODULE_3__.isInvalid)(invalid[SRCHITEM], -1) === true ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "errMessage"
      ...
      return regeneratorRuntime.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              return _context7.abrupt("return", searchItemButton());
  ...
  var footer = props.hasOwnProperty('nofooter') === true ? null : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    style: footStyle
  }, props.hasOwnProperty('norows') === true ? null : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    style: marginStyle
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_List__WEBPACK_IMPORTED_MODULE_2__.Choice, {
    choices: rowValues,
    name: "rows",
    ...
    style: noBorderStyle,
    disabled: error
  }), "rows"), topButtonHTML, previousButtonHTML, props.hasOwnProperty('nodisplay') === true ? null : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, start + ' - ' + end + ' of ' + props.data.length), nextButtonHTML, bottomButtonHTML);
  ...
  return (
    ...
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      style: divStyle
    }, title, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, props.hasOwnProperty('sfbottom') === false ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, filterSection, searchSection, allButtonHTML, letters) : null), props.data.length === 0 && props.hasOwnProperty('showtable') === false ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, "No Data to Display") : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      style: tableDivStyle
    ...
    }, props.table.map(buildHeaders)), showData.map(props.eachRowInTable), props.hasOwnProperty('footer') === true ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tr", {
      style: footerStyle
    }, props.footer.map(buildFooter)) : null))), footer, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, props.hasOwnProperty('sfbottom') === true ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, filterSection, searchSection, allButtonHTML, letters) : null)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_AlertModal__WEBPACK_IMPORTED_MODULE_4__.default, {
      show: showAlert,
  ...
  function buildHeaders(row, i) {
    ...
    if (filterOn === 'Y' && props.hasOwnProperty('nofilter') === false) {
      var filterStyle = (0,_Invalid__WEBPACK_IMPORTED_MODULE_3__.copyStyle)(widthStyle);
      filterStyle.backgroundColor = Theme.normalColor;
      filterStyle = (0,_Invalid__WEBPACK_IMPORTED_MODULE_3__.processStyleScreen)(invalid, FILTER, filterStyle);

      if (row.sort === false || props.hasOwnProperty('nosort') === true) {
    ...
    } else if (row.sort === false || props.hasOwnProperty('nosort') === true) {
      // No sorting, so no onClick handler
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("th", {
        key: key,
        style: headerStyle
  ...
  function filterValidate() {
    ...
    localInvalid = (0,_Invalid__WEBPACK_IMPORTED_MODULE_3__.setInvalidScreen)(localInvalid, FILTER, '');
  ...
  function filterButton() {
    ...
    for (var _i8 = 0; _i8 < data.length; _i8++) {
      ...
      for (var j = 0; j < indexes.length && done === false; j++) {
        ...
        if (data[_i8][props.table[indexes[j]].name].toString().indexOf(filter[indexes[j]]) !== -1) {
  ...
  function validate(which) {
    ...
    if (searchHeader === '') {
      localInvalid = (0,_Invalid__WEBPACK_IMPORTED_MODULE_3__.setInvalidScreen)(localInvalid, SRCHHDR, 'A column header to be searched must be selected');
    }

    if (which === 'B' && searchItem === '') {
      localInvalid = (0,_Invalid__WEBPACK_IMPORTED_MODULE_3__.setInvalidScreen)(localInvalid, SRCHITEM, 'An item to search must be entered');
    }
  ...
  function searchItemButton() {
    if (validate('B') === true) {
      ...
      var search = null;
      search = props.hasOwnProperty('ignorecase') === true ? searchItem.toUpperCase() : // Convert to upper case to ignore case
  ...
  function searchStart(search, name) {
    var begin = props.hasOwnProperty('nocontsearch') === true || start === 0 ? 0 : start + 1; // Where to start the search
  ...
  function sortClicked(name, orderType) {
    ...
    props.data.sort(function (item1, item2) {
      ...
      if (typeof item1[name] === 'string' && props.hasOwnProperty('ignorecase') === true) {
  ...
  function letterLink(letter) {
    if (validate('H') === true) {
      ...
      var next = false; // Indicates that the end of the letter was found
...
/*! export defaultThemeSettings [provided] [no usage info] [missing usage info prevents renaming] */
/*! export generateButton [provided] [no usage info] [missing usage info prevents renaming] */
/*! export generateDefaultButton [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
/*! runtime requirements: __webpack_require__.r, __webpack_exports__, __webpack_require__.d, __webpack_require__.* */
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var generateButton = function generateButton(style, error) {
  ...
  if (error === true || disabled === true) {
    ...
    genButtonStyle.backgroundColor = style.hasOwnProperty('backgroundColor') === true ? style.backgroundColor : Theme.getBackgroundColor();
  }
...
var generateDefaultButton = function generateDefaultButton(error) {
  ...
  var genButtonStyle = Object.assign({}, Theme.getButtonStyle()); // Copy the button style
...
/* harmony import */ var react_day_picker__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react-day-picker */ "./node_modules/react-day-picker/build/index.js");
/* harmony import */ var react_day_picker_DayPickerInput__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! react-day-picker/DayPickerInput */ "./node_modules/react-day-picker/DayPickerInput/index.js");
/* harmony import */ var _DatePickerStyle__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./DatePickerStyle */ "./src/DatePickerStyle.js");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function parseDate(str, format, locale) {
  var parsed = (0,date_fns_parse__WEBPACK_IMPORTED_MODULE_5__.default)(str, format, {
    locale: locale
  });
...
function formatDate(date, format, locale) {
  return (0,date_fns_format__WEBPACK_IMPORTED_MODULE_6__.default)(date, format, {
    locale: locale
  });
}
...
var UnstyledDatePicker = /*#__PURE__*/function (_React$Component) {
  ...
  function UnstyledDatePicker(props) {
    ...
    if (_this.props.defaultStyles) (0,_DatePickerStyle__WEBPACK_IMPORTED_MODULE_4__.DatePickerStyle)(); // }
  ...
  _createClass(UnstyledDatePicker, [{
    ...
    value: function handleDayChange(selectedDay, modifiers, dayPickerInput) {
      var value = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_6__.default)(selectedDay, this.props.format); // console.log('name:', this.props.name, 'day:', value);
    ...
    value: function render() {
      ...
      props.format = format;
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_day_picker_DayPickerInput__WEBPACK_IMPORTED_MODULE_3__.default, _extends({}, props, {
        formatDate: formatDate,
        parseDate: parseDate,
        onDayChange: this.handleDayChange,
        placeholder: "".concat((0,date_fns_format__WEBPACK_IMPORTED_MODULE_6__.default)(new Date(), format))
      }));
    }
  }]);
...
/*!**********************!*\
  ...
  \**********************/
/*! namespace exports */
/*! export AlertModal [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/AlertModal.js .default */
/*! export CheckBox [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/CheckBox.js .default */
/*! export Choice [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/List.js .Choice */
/*! export ChoiceText [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/ChoiceText.js .default */
/*! export ConfirmModal [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/ConfirmModal.js .default */
/*! export DatePicker [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/DatePicker.js .default */
/*! export DatePickerStyle [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/DatePickerStyle.js .DatePickerStyle */
/*! export DoubleListBox [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/DoubleListBox.js .default */
/*! export ErrorModal [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/ErrorModal.js .default */
/*! export List [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/List.js .List */
/*! export Modal [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Modal.js .default */
/*! export Radio [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Radio.js .default */
/*! export SearchSortTable [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/SearchSortTable.js .default */
/*! export buttonStyle [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Theme.js .buttonStyle */
/*! export clearInvalidDual [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Invalid.js .clearInvalidDual */
/*! export clearInvalidScreen [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Invalid.js .clearInvalidScreen */
/*! export clearInvalidScreenOnly [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Invalid.js .clearInvalidScreenOnly */
/*! export clearInvalidTable [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Invalid.js .clearInvalidTable */
/*! export copyStyle [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Invalid.js .copyStyle */
/*! export defaultThemeSettings [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Theme.js .defaultThemeSettings */
/*! export generateButton [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Theme.js .generateButton */
/*! export generateDefaultButton [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Theme.js .generateDefaultButton */
/*! export getInvalidMessage [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Invalid.js .getInvalidMessage */
/*! export invalidStyling [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Invalid.js .invalidStyling */
/*! export isConstant [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Invalid.js .isConstant */
/*! export isInvalid [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Invalid.js .isInvalid */
/*! export processStyleScreen [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Invalid.js .processStyleScreen */
/*! export processStyleTable [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Invalid.js .processStyleTable */
/*! export resetDisplayScreen [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Invalid.js .resetDisplayScreen */
/*! export resetDisplayTable [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Invalid.js .resetDisplayTable */
/*! export setInvalidDual [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Invalid.js .setInvalidDual */
/*! export setInvalidScreen [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Invalid.js .setInvalidScreen */
/*! export setInvalidTable [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Invalid.js .setInvalidTable */
/*! export validCheckDual [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Invalid.js .validCheckDual */
/*! export validCheckScreen [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Invalid.js .validCheckScreen */
/*! export validCheckTable [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Invalid.js .validCheckTable */
/*! export validStyling [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Invalid.js .validStyling */
/*! export wasClickedScreen [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Invalid.js .wasClickedScreen */
/*! export wasClickedTable [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Invalid.js .wasClickedTable */
...
/* harmony export */   "ChoiceText": () => /* reexport safe */ _ChoiceText__WEBPACK_IMPORTED_MODULE_2__.default,
/* harmony export */   "Radio": () => /* reexport safe */ _Radio__WEBPACK_IMPORTED_MODULE_3__.default,
/* harmony export */   "DatePicker": () => /* reexport safe */ _DatePicker__WEBPACK_IMPORTED_MODULE_4__.default,
/* harmony export */   "DoubleListBox": () => /* reexport safe */ _DoubleListBox__WEBPACK_IMPORTED_MODULE_5__.default,
/* harmony export */   "AlertModal": () => /* reexport safe */ _AlertModal__WEBPACK_IMPORTED_MODULE_6__.default,
/* harmony export */   "ConfirmModal": () => /* reexport safe */ _ConfirmModal__WEBPACK_IMPORTED_MODULE_7__.default,
/* harmony export */   "ErrorModal": () => /* reexport safe */ _ErrorModal__WEBPACK_IMPORTED_MODULE_8__.default,
/* harmony export */   "Modal": () => /* reexport safe */ _Modal__WEBPACK_IMPORTED_MODULE_9__.default,
/* harmony export */   "SearchSortTable": () => /* reexport safe */ _SearchSortTable__WEBPACK_IMPORTED_MODULE_10__.default,
/* harmony export */   "DatePickerStyle": () => /* reexport safe */ _DatePickerStyle_js__WEBPACK_IMPORTED_MODULE_11__.DatePickerStyle,
/* harmony export */   "clearInvalidDual": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_12__.clearInvalidDual,
/* harmony export */   "clearInvalidScreen": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_12__.clearInvalidScreen,
/* harmony export */   "clearInvalidScreenOnly": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_12__.clearInvalidScreenOnly,
/* harmony export */   "clearInvalidTable": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_12__.clearInvalidTable,
/* harmony export */   "copyStyle": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_12__.copyStyle,
/* harmony export */   "getInvalidMessage": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_12__.getInvalidMessage,
/* harmony export */   "invalidStyling": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_12__.invalidStyling,
/* harmony export */   "isConstant": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_12__.isConstant,
/* harmony export */   "isInvalid": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_12__.isInvalid,
/* harmony export */   "processStyleScreen": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_12__.processStyleScreen,
/* harmony export */   "processStyleTable": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_12__.processStyleTable,
/* harmony export */   "resetDisplayScreen": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_12__.resetDisplayScreen,
/* harmony export */   "resetDisplayTable": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_12__.resetDisplayTable,
/* harmony export */   "setInvalidDual": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_12__.setInvalidDual,
/* harmony export */   "setInvalidScreen": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_12__.setInvalidScreen,
/* harmony export */   "setInvalidTable": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_12__.setInvalidTable,
/* harmony export */   "validCheckDual": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_12__.validCheckDual,
/* harmony export */   "validCheckScreen": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_12__.validCheckScreen,
/* harmony export */   "validCheckTable": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_12__.validCheckTable,
/* harmony export */   "validStyling": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_12__.validStyling,
/* harmony export */   "wasClickedScreen": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_12__.wasClickedScreen,
/* harmony export */   "wasClickedTable": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_12__.wasClickedTable,
/* harmony export */   "Choice": () => /* reexport safe */ _List_js__WEBPACK_IMPORTED_MODULE_13__.Choice,
/* harmony export */   "List": () => /* reexport safe */ _List_js__WEBPACK_IMPORTED_MODULE_13__.List,
/* harmony export */   "buttonStyle": () => /* reexport safe */ _Theme_js__WEBPACK_IMPORTED_MODULE_14__.buttonStyle,
/* harmony export */   "defaultThemeSettings": () => /* reexport safe */ _Theme_js__WEBPACK_IMPORTED_MODULE_14__.defaultThemeSettings,
/* harmony export */   "generateButton": () => /* reexport safe */ _Theme_js__WEBPACK_IMPORTED_MODULE_14__.generateButton,
/* harmony export */   "generateDefaultButton": () => /* reexport safe */ _Theme_js__WEBPACK_IMPORTED_MODULE_14__.generateDefaultButton
/* harmony export */ });
...
/* harmony import */ var _CheckBox__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./CheckBox */ "./src/CheckBox.js");
/* harmony import */ var _ChoiceText__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ChoiceText */ "./src/ChoiceText.js");
/* harmony import */ var _Radio__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Radio */ "./src/Radio.js");
/* harmony import */ var _DatePicker__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./DatePicker */ "./src/DatePicker.js");
/* harmony import */ var _DoubleListBox__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./DoubleListBox */ "./src/DoubleListBox.js");
/* harmony import */ var _AlertModal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./AlertModal */ "./src/AlertModal.js");
/* harmony import */ var _ConfirmModal__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ConfirmModal */ "./src/ConfirmModal.js");
/* harmony import */ var _ErrorModal__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./ErrorModal */ "./src/ErrorModal.js");
/* harmony import */ var _Modal__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./Modal */ "./src/Modal.js");
/* harmony import */ var _SearchSortTable__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./SearchSortTable */ "./src/SearchSortTable.js");
/* harmony import */ var _DatePickerStyle_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./DatePickerStyle.js */ "./src/DatePickerStyle.js");
/* harmony import */ var _Invalid_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./Invalid.js */ "./src/Invalid.js");
/* harmony import */ var _List_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./List.js */ "./src/List.js");
...
/*!**********************************************!*\
  ...
  \**********************************************/
/*! dynamic exports */
/*! export __esModule [maybe provided (runtime-defined)] [no usage info] [provision prevents renaming (no use info)] -> ./node_modules/react-autobind/lib/autoBind.js .__esModule */
/*! other exports [maybe provided (runtime-defined)] [no usage info] -> ./node_modules/react-autobind/lib/autoBind.js */
/*! runtime requirements: module, __webpack_require__ */
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
/*!***************************************************************!*\
  ...
  \***************************************************************/
/*! dynamic exports */
/*! export HIDE_TIMEOUT [provided] [no usage info] [provision prevents renaming (no use info)] -> ./node_modules/react-day-picker/build/DayPickerInput.js .HIDE_TIMEOUT */
/*! export OverlayComponent [provided] [no usage info] [provision prevents renaming (no use info)] -> ./node_modules/react-day-picker/build/DayPickerInput.js .OverlayComponent */
/*! export __esModule [provided] [no usage info] [provision prevents renaming (no use info)] -> ./node_modules/react-day-picker/build/DayPickerInput.js .__esModule */
/*! export default [provided] [no usage info] [provision prevents renaming (no use info)] -> ./node_modules/react-day-picker/build/DayPickerInput.js .default */
/*! export defaultFormat [provided] [no usage info] [provision prevents renaming (no use info)] -> ./node_modules/react-day-picker/build/DayPickerInput.js .defaultFormat */
/*! export defaultParse [provided] [no usage info] [provision prevents renaming (no use info)] -> ./node_modules/react-day-picker/build/DayPickerInput.js .defaultParse */
/*! other exports [not provided] [no usage info] */
/*! runtime requirements: module, __webpack_require__ */
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
/*! flagged exports */
/*! export __esModule [provided] [no usage info] [missing usage info prevents renaming] */
/*! export addDayToRange [provided] [no usage info] [missing usage info prevents renaming] */
...
/*! export default [provided] [no usage info] [missing usage info prevents renaming] */
/*! export getWeekNumber [provided] [no usage info] [missing usage info prevents renaming] */
/*! export isDate [provided] [no usage info] [missing usage info prevents renaming] */
/*! export isDayAfter [provided] [no usage info] [missing usage info prevents renaming] */
/*! export isDayBefore [provided] [no usage info] [missing usage info prevents renaming] */
/*! export isDayBetween [provided] [no usage info] [missing usage info prevents renaming] */
/*! export isDayInRange [provided] [no usage info] [missing usage info prevents renaming] */
/*! export isFutureDay [provided] [no usage info] [missing usage info prevents renaming] */
/*! export isPastDay [provided] [no usage info] [missing usage info prevents renaming] */
...
/*! export DayPicker [provided] [no usage info] [missing usage info prevents renaming] */
/*! export LocaleUtils [provided] [no usage info] [missing usage info prevents renaming] */
/*! export ModifiersUtils [provided] [no usage info] [missing usage info prevents renaming] */
/*! export __esModule [provided] [no usage info] [missing usage info prevents renaming] */
/*! export default [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
/*! runtime requirements: __webpack_exports__, __webpack_require__ */
...
/*!***************************************************************!*\
  ...
  \***************************************************************/
/*! flagged exports */
/*! export HIDE_TIMEOUT [provided] [no usage info] [missing usage info prevents renaming] */
/*! export OverlayComponent [provided] [no usage info] [missing usage info prevents renaming] */
/*! export __esModule [provided] [no usage info] [missing usage info prevents renaming] */
/*! export default [provided] [no usage info] [missing usage info prevents renaming] */
/*! export defaultFormat [provided] [no usage info] [missing usage info prevents renaming] */
/*! export defaultParse [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
/*! runtime requirements: __webpack_exports__, __webpack_require__ */
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/*! flagged exports */
/*! export __esModule [provided] [no usage info] [missing usage info prevents renaming] */
/*! export cancelEvent [provided] [no usage info] [missing usage info prevents renaming] */
/*! export getDayNodes [provided] [no usage info] [missing usage info prevents renaming] */
/*! export getDaysInMonth [provided] [no usage info] [missing usage info prevents renaming] */
/*! export getFirstDayOfMonth [provided] [no usage info] [missing usage info prevents renaming] */
/*! export getFirstDayOfWeekFromProps [provided] [no usage info] [missing usage info prevents renaming] */
/*! export getModifiersFromProps [provided] [no usage info] [missing usage info prevents renaming] */
/*! export getMonthsDiff [provided] [no usage info] [missing usage info prevents renaming] */
/*! export getWeekArray [provided] [no usage info] [missing usage info prevents renaming] */
/*! export hasOwnProp [provided] [no usage info] [missing usage info prevents renaming] */
/*! export isRangeOfDates [provided] [no usage info] [missing usage info prevents renaming] */
/*! export nodeListToArray [provided] [no usage info] [missing usage info prevents renaming] */
...
/*! export __esModule [provided] [no usage info] [missing usage info prevents renaming] */
/*! export default [provided] [no usage info] [missing usage info prevents renaming] */
/*! export formatDay [provided] [no usage info] [missing usage info prevents renaming] */
/*! export formatMonthTitle [provided] [no usage info] [missing usage info prevents renaming] */
/*! export formatWeekdayLong [provided] [no usage info] [missing usage info prevents renaming] */
/*! export formatWeekdayShort [provided] [no usage info] [missing usage info prevents renaming] */
/*! export getFirstDayOfWeek [provided] [no usage info] [missing usage info prevents renaming] */
/*! export getMonths [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
/*! runtime requirements: __webpack_exports__ */
/***/ ((__unused_webpack_module, exports) => {
...
/*! flagged exports */
/*! export __esModule [provided] [no usage info] [missing usage info prevents renaming] */
/*! export dayMatchesModifier [provided] [no usage info] [missing usage info prevents renaming] */
/*! export default [provided] [no usage info] [missing usage info prevents renaming] */
/*! export getModifiersForDay [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
/*! runtime requirements: __webpack_exports__, __webpack_require__ */
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/*! export ESC [provided] [no usage info] [missing usage info prevents renaming] */
