...
var SearchSortTable = function SearchSortTable(propsPassed) {
  ...
  */
  ...
  var genButtonStyle = (0,_Theme__WEBPACK_IMPORTED_MODULE_5__.generateButton)(buttonStyle, props.error, false, 'gray');
  var genTopButtonStyle = (0,_Theme__WEBPACK_IMPORTED_MODULE_5__.generateButton)(noButtonStyle, props.error, topDisabled, 'gray');
  var genPreviousButtonStyle = (0,_Theme__WEBPACK_IMPORTED_MODULE_5__.generateButton)(noButtonStyle, props.error, previousDisabled, 'gray');
  var genNextButtonStyle = (0,_Theme__WEBPACK_IMPORTED_MODULE_5__.generateButton)(noButtonStyle, props.error, nextDisabled, 'gray');
  var genBottomButtonStyle = (0,_Theme__WEBPACK_IMPORTED_MODULE_5__.generateButton)(noButtonStyle, props.error, bottomDisabled, 'gray');
  var genFilterButtonStyle = (0,_Theme__WEBPACK_IMPORTED_MODULE_5__.generateButton)(buttonStyle, props.error, filterDisabled, 'gray');
...
var generateButton = function generateButton(style, error) {
  ...
  if (error === true || disabled === true) {
    ...
    genButtonStyle.backgroundColor = style.hasOwnProperty('backgroundColor') === true ? style.backgroundColor : defaultThemeSettings.backgroundColor;
  }
