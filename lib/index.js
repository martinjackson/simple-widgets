...
var AlertModal = function AlertModal(props) {
  var buttonStyle = {
    margin: "10px",
    borderRadius: "10px",
    color: _Theme__WEBPACK_IMPORTED_MODULE_2__.default.getButtonFGColor(),
    backgroundColor: _Theme__WEBPACK_IMPORTED_MODULE_2__.default.getButtonBGColor(),
    width: "100px",
    height: "30px",
    font: _Theme__WEBPACK_IMPORTED_MODULE_2__.default.getButtonFont(),
    fontWeight: "bold"
  };
...
var copyStyle = function copyStyle(_copyStyle) {
  ...
  style.backgroundColor = _Theme__WEBPACK_IMPORTED_MODULE_0__.default.getNormalBackColor();
  return style;
};
/***********************************************************************************************
 * 
...
var processStyleScreen = function processStyleScreen(invalidValues, constant, style) {
  if (invalidValues[constant].validity === true) {
    // and the entry is invalid
    style.backgroundColor = _Theme__WEBPACK_IMPORTED_MODULE_0__.default.getErrorColor();
  } else {
    style.backgroundColor = _Theme__WEBPACK_IMPORTED_MODULE_0__.default.getNormalBackColor();
  }
...
var validStyling = function validStyling() {
  var validStyle = {
    backgroundColor: _Theme__WEBPACK_IMPORTED_MODULE_0__.default.getNormalBackColor()
  };
  return validStyle;
};
/**********************************************************************************************
...
var invalidStyling = function invalidStyling() {
  var invalidStyle = {
    backgroundColor: _Theme__WEBPACK_IMPORTED_MODULE_0__.default.getErrorColor()
  };
  return invalidStyle;
};
/*********************************************************************************************
...
var SearchSortTable = function SearchSortTable(props) {
  ...
  var divStyle = {
    ...
    margin: "5px",
    padding: "10px",
    backgroundColor: _Theme__WEBPACK_IMPORTED_MODULE_5__.default.getBackgroundColor() // "#CCCC66",
  ...
  var buttonStyle = {
    margin: "10px",
    borderRadius: "10px",
    color: _Theme__WEBPACK_IMPORTED_MODULE_5__.default.getButtonFGColor(),
    backgroundColor: _Theme__WEBPACK_IMPORTED_MODULE_5__.default.getButtonBGColor(),
    width: "100px",
    height: "30px",
    font: _Theme__WEBPACK_IMPORTED_MODULE_5__.default.getButtonFont(),
    fontWeight: "bold"
  };
  ...
  var searchStyle = {
    margin: "5px",
    backgroundColor: _Theme__WEBPACK_IMPORTED_MODULE_5__.default.getNormalBackColor()
  };
  var footStyle = {
    margin: "10px",
    textAlign: "right",
    ...
    bottom: 0,
    zIndex: 2,
    backgroundColor: _Theme__WEBPACK_IMPORTED_MODULE_5__.default.getBackgroundColor()
  };
  ...
  var genButtonStyle = _Theme__WEBPACK_IMPORTED_MODULE_5__.default.generateButton(buttonStyle, error, false, 'gray');
  var genTopButtonStyle = _Theme__WEBPACK_IMPORTED_MODULE_5__.default.generateButton(noButtonStyle, error, topDisabled, 'gray');
  var genPreviousButtonStyle = _Theme__WEBPACK_IMPORTED_MODULE_5__.default.generateButton(noButtonStyle, error, previousDisabled, 'gray');
  var genNextButtonStyle = _Theme__WEBPACK_IMPORTED_MODULE_5__.default.generateButton(noButtonStyle, error, nextDisabled, 'gray');
  var genBottomButtonStyle = _Theme__WEBPACK_IMPORTED_MODULE_5__.default.generateButton(noButtonStyle, error, bottomDisabled, 'gray');
  var genFilterButtonStyle = _Theme__WEBPACK_IMPORTED_MODULE_5__.default.generateButton(buttonStyle, error, filterDisabled, 'gray');
  ...
  function buildHeaders(row, i) {
    ...
    if (filterOn === 'Y' && props.hasOwnProperty('nofilter') === false) {
      ...
      filterStyle.backgroundColor = _Theme__WEBPACK_IMPORTED_MODULE_5__.default.getNormalBackColor();
...
var Theme = /*#__PURE__*/function () {
  ...
  _createClass(Theme, null, [{
    ...
    key: "getButtonBGColor",
    value: function getButtonBGColor() {
      return buttonColor;
    }
    /*****************************************************************************
     *
    ...
    key: "getButtonFGColor",
    value: function getButtonFGColor() {
    ...
    key: "getNormalBackColor",
    value: function getNormalBackColor() {
      return normalColor;
    }
    /********************************************************************************
     * 
    ...
    key: "generateButton",
    value: function generateButton(style, error, disabled, disableColor) {
...
/*! export Theme [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/Theme.js .default */
...
/*! export makeChangeHandler [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] -> ./src/makeChangeHandler.js .default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "makeChangeHandler": () => /* reexport safe */ _makeChangeHandler__WEBPACK_IMPORTED_MODULE_0__.default,
/* harmony export */   "CheckBox": () => /* reexport safe */ _CheckBox__WEBPACK_IMPORTED_MODULE_1__.default,
/* harmony export */   "Choice": () => /* reexport safe */ _List__WEBPACK_IMPORTED_MODULE_2__.Choice,
/* harmony export */   "ChoiceText": () => /* reexport safe */ _ChoiceText__WEBPACK_IMPORTED_MODULE_3__.default,
/* harmony export */   "List": () => /* reexport safe */ _List__WEBPACK_IMPORTED_MODULE_2__.List,
/* harmony export */   "Radio": () => /* reexport safe */ _Radio__WEBPACK_IMPORTED_MODULE_4__.default,
/* harmony export */   "DatePicker": () => /* reexport safe */ _DatePicker__WEBPACK_IMPORTED_MODULE_5__.default,
/* harmony export */   "DoubleListBox": () => /* reexport safe */ _DoubleListBox__WEBPACK_IMPORTED_MODULE_6__.default,
/* harmony export */   "AlertModal": () => /* reexport safe */ _AlertModal__WEBPACK_IMPORTED_MODULE_7__.default,
/* harmony export */   "ConfirmModal": () => /* reexport safe */ _ConfirmModal__WEBPACK_IMPORTED_MODULE_8__.default,
/* harmony export */   "ErrorModal": () => /* reexport safe */ _ErrorModal__WEBPACK_IMPORTED_MODULE_9__.default,
...
/* harmony export */   "setInvalidScreen": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_13__.setInvalidScreen,
/* harmony export */   "setInvalidTable": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_13__.setInvalidTable,
/* harmony export */   "setInvalidDual": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_13__.setInvalidDual,
/* harmony export */   "resetDisplayScreen": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_13__.resetDisplayScreen,
/* harmony export */   "resetDisplayTable": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_13__.resetDisplayTable,
/* harmony export */   "wasClickedScreen": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_13__.wasClickedScreen,
/* harmony export */   "wasClickedTable": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_13__.wasClickedTable,
/* harmony export */   "isConstant": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_13__.isConstant,
/* harmony export */   "validCheckDual": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_13__.validCheckDual,
/* harmony export */   "validCheckScreen": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_13__.validCheckScreen,
/* harmony export */   "validCheckTable": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_13__.validCheckTable,
/* harmony export */   "clearInvalidDual": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_13__.clearInvalidDual,
/* harmony export */   "clearInvalidScreen": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_13__.clearInvalidScreen,
/* harmony export */   "clearInvalidTable": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_13__.clearInvalidTable,
/* harmony export */   "copyStyle": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_13__.copyStyle,
/* harmony export */   "processStyleScreen": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_13__.processStyleScreen,
/* harmony export */   "processStyleTable": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_13__.processStyleTable,
/* harmony export */   "validStyling": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_13__.validStyling,
/* harmony export */   "invalidStyling": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_13__.invalidStyling,
/* harmony export */   "isInvalid": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_13__.isInvalid,
/* harmony export */   "getInvalidMessage": () => /* reexport safe */ _Invalid_js__WEBPACK_IMPORTED_MODULE_13__.getInvalidMessage,
/* harmony export */   "SearchSortTable": () => /* reexport safe */ _SearchSortTable__WEBPACK_IMPORTED_MODULE_12__.default
/* harmony export */ });
...
/* harmony import */ var _AlertModal__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./AlertModal */ "./src/AlertModal.js");
/* harmony import */ var _ConfirmModal__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./ConfirmModal */ "./src/ConfirmModal.js");
/* harmony import */ var _ErrorModal__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./ErrorModal */ "./src/ErrorModal.js");
...
/* harmony import */ var _SearchSortTable__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./SearchSortTable */ "./src/SearchSortTable.js");
/* harmony import */ var _Invalid_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./Invalid.js */ "./src/Invalid.js");
// functions
; // React.Components
