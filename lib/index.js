...
var processInvalidStyleScreen = function processInvalidStyleScreen(invalidValues, constant) {
  ...
  console.log('backCSSName :', backCSSName); // Set the background color based on whether the value is invalid or not
...
var processInvalidStyleTable = function processInvalidStyleTable(invalidValues, constant, pos) {
  ...
  console.log('invalidValues :', invalidValues); // Spin through the validity array for that item in the invalid values array
